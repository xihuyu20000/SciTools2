...
'''
import unittest
from api.biz import biz_parsefile
...
class TestUtil(unittest.TestCase):
    ...
    def test_import_file_zip(self):
        ...
        db.drop_ods_bib()
        db.create_ods_bib()
        count = biz_parsefile.import_file(config.ds_gbt_7714_2015, 'dataset/importfile_biz/ds_gbt_7714_2015.zip')
    ...
    def test_import_file_gbt_7714_2015(self):
        ...
        db.drop_ods_bib()
        db.create_ods_bib()
        count = biz_parsefile.import_file(config.ds_gbt_7714_2015, 'dataset/importfile_biz/ds_gbt_7714_2015.txt')
    ...
    def test_import_file_note_express(self):
        ...
        db.drop_ods_bib()
        db.create_ods_bib()
        count = biz_parsefile.import_file(config.ds_note_express, 'dataset/importfile_biz/NoteExpress.net')
