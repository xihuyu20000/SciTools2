      ...
      menu: [
        {
          title: '基础指标',
          children: [
            { title: '历年发文量', path: '/scimetrics-stat/statArticlesByYear' },
            { title: '国家发文量', path: '/scimetrics-stat/statArticlesByCountry' },
            { title: '地区发文量', path: '/scimetrics-stat/statArticlesByProvince' },
            { title: '机构发文量', path: '/scimetrics-stat/statArticlesByOrg' },
            { title: '期刊发文量', path: '/scimetrics-stat/statArticlesByJournal' },
            { title: '一作发文量', path: '/scimetrics-stat/statArticlesByFirstDuty' },
            { title: '作者发文量', path: '/scimetrics-stat/statArticlesByAuthor' },
            { title: '基金类型统计', path: '/scimetrics-stat/statArticlesByFund' },
            // { title: '学科分布', path: '/scimetrics-stat/statArticlesBySubject' },
            { title: '合作人数统计', path: '/scimetrics-stat/statPersonsByCoAuthor' },
            { title: '关键词词频', path: '/scimetrics-stat/statKwsByCount' }
          ]
        },
        // {
        //   title: '绘制词云',
